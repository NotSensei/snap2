...
import { ChevronDown, ChevronUp, CreditCard, Hash, MapPin, Package, Truck, UserCheck } from 'lucide-react'
    ...
    const getStatusColor = (status: string) => {
        switch (status) {
            ...
            case "out of delivery":
                return "bg-blue-100 text-blue-700 border-blue-100 border-blue-300"
            case "delivered":
                return "bg-green-100 text-green-700 border-green-300"
            default:
                return "bg-gray-100 text-gray-100 border-gray-300"
        }
    }
    ...
    return (
        ...
        >
            ...
            {status != "delivered" && <div className='p-5 space-y-4'>
                ...
                {order.assignedDeliveryBoy && <><div className='mt-4 bg-blue-50 border border-blue-100 rounded-xl p-4 flex items-center justify-between'>
                ...
                <div className='flex items-center gap-2 text-gray-700 text-sm'>
                    ...
                    <span className='truncate'>{order.address?.fullAddress || "Address not available"}</span>
                </div>
