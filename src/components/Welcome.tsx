...
type propType = {
    nextStep: (params: number) => void
}

function Welcome({nextStep}:propType) {
    return (
        <div className='flex flex-col items-center justify-center min-h-screen text-center p-6 bg-linear-to-b from-green-100 to-whit '>
            <motion.div
                initial={{
                    opacity: 0,
                    y: -20
            ...
            <motion.button
                ...
                className='inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-8 rounded-2xl shadow-md transition-all duration-200 mt-4'
                onClick={() => nextStep(2)}
            >
                Next
                <ArrowRight />
