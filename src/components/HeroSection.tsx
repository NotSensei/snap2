...
function HeroSection() {
    ...
    const slides = [
        ...
        },
        {
            ...
            btnTxt: "Get Started",
            bg: "https://plus.unsplash.com/premium_photo-1663091378026-7bee6e1c7247?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGJhZyUyMG9mJTIwZ3JvY2VyaWVzfGVufDB8fDB8fHww"
        },
    ]
        ...
        <div className='relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl'>
            <AnimatePresence mode='wait'>
                <motion.div
                    ...
                    exit={{ opacity: 0 }}
                    className='absolute inset-0' // all sides are equal to 0 pixels
                >
                    <Image
