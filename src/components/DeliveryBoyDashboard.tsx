...
function DeliveryBoyDashboard({ earning }: { earning: number }) {
    ...
    const handleAccept = async (id: string) => {
        try {
            const result = await axios.get(`/api/delivery/assignment/${id}/accept-assignments`)
            fetchCurrentOrder()
        } catch (error) {
            console.log(error)
        }
            ...
            <div className='flex items-center justify-center min-h-screen bg-linear-to-br from-white to-green-50 p-6'>
                <div className='max-w-md w-full text-center'>
                    ...
                    <div className='bg-white border rounded-xl shadow-xl p-6'>
                        ...
                        <button className='mt-4 w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded-lg cursor-pointer' onClick={() => window.location.reload()}>Refresh Earning</button>
        ...
        return (
            <div className='p-4 pt-[120px] min-h-screen bg-gray-50'>
                <div className='max-w-3xl mx-auto'>
                    ...
                    <div className='rounded-xl border shadow-lg overflow-hidden mb-6 z-0'>
             ...
             flex items-center justify-center"
                        ...
                        )}
                        {
                            ...
                            <div className='mt-4'>
                                ...
                                />
                                <button
                                    className="w-full mt-4 bg-blue-600 text-white py-3 rounded-lg cursor-pointer
             flex items-center justify-center"
                                    onClick={verifyOtp}
                                >
                                    {verifyOtpLoading ? (
