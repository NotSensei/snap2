...
import { ArrowLeft, Building2, CreditCard, CreditCardIcon, Home, Loader2, LocateFixed, MapPin, Navigation, Phone, Tag, Truck, User } from 'lucide-react'
...
function Checkout() {
    ...
    return (
        <div className='w-[92%] md:w-[80%] mx-auto py-10 relative'>
            <motion.button
                whileTap={{ scale: 0.97 }}
                className='aboslute left-0 top-2 flex items-center gap-2 text-green-700 hover:text-green-800 font-semibold'
                ...
                >
                    ...
                    <div className='space-y-4'>
                        ...
                        <div className='grid grid-cols-3 gap-3'>
                            <div className='relative'>
                                <Building2 className='absolute left-3 top-3 text-green-600' size={18} />
                            ...
                            <div className='relative'>
                                <Tag className='absolute left-3 top-3 text-green-600' size={18} />
