'use client'
import { EyeIcon, EyeOff, KeyRound, Leaf, Loader2, LogIn, Mail } from 'lucide-react'
...
function Login() {
    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
            ...
            <p className='text-gray-600 mb-8 flex items-center'>Login To SnapCart <Leaf className='w-5 h-5 text-green-600 ml-1' /></p>
            <motion.form
                ...
                <p className='text-gray-600 mt-6 text-sm flex items-center gap-1 cursor-pointer' onClick={() => router.push('/register')}>Want to create an account ? <LogIn className='w-4 h-4' /> <span className='text-green-500'> Sign Up</span></p>
        </div>
    )
}
